...
// -----------------------------------------------------------------
// 1. تعريف شاشة المركز (Cinter) - تم دمج محتوى مركز 140 هنا
// -----------------------------------------------------------------

class Cinter extends StatelessWidget {
  const Cinter({super.key});

  @override
  Widget build(BuildContext context) {
    // تحديد الاتجاه من اليمين إلى اليسار (RTL)
...
// -----------------------------------------------------------------
// 2. محتوى شاشة مركز 140 الرئيسي (حالة المركبات)
// -----------------------------------------------------------------

class _CenterMainContent extends StatelessWidget {
  const _CenterMainContent();

  // بيانات المركبات التابعة للمركز 140 (104 و 102)
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // أ. عرض حالة المركبات العاملة على الأرض
        Text(
        ...
        // ب. منطقة الخريطة (عرض مواقع المركبات 102 و 104)
        Text(
          'تتبع حي للمركبات',
          style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold),
        ),
